        ...
        <div className="text-center my-2">
          ...
          >
            ...
            {isLoading
              ? "Salvataggio..."
              : hasSubmitted
                ? "Modifica Stato Salute"
                : "Segnala Stato di Salute"}
          </Button>
        </div>
      )}
      ...
      <Modal show={showModal} onHide={handleCloseModal} centered className={styles.healthModal}>
        <Modal.Header closeButton className={styles.modalHeader}>
          <div className={styles.headerContent}>
            <Modal.Title className={styles.modalTitle}>Segnala lo stato di salute</Modal.Title>
              ...
              <Col key={health.level} className={styles.healthCol}>
                ...
                >
                  <div className={styles.buttonContent}>
                    ...
                    <div className={styles.healthLevel}>Livello {health.level}</div>
                  </div>
                </Button>
              </Col>
            ))}
